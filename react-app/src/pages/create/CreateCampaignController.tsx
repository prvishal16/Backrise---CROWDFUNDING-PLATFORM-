...
const CreateCampaignController: FC = () => {
  ...
  const cloudinary = {
    url: import.meta.env.VITE_CLOUDINARY_UPLOAD_URL as RequestInfo,
    cloud: import.meta.env.VITE_CLOUDINARY_CLOUD_NAME as DataUnion,
    preset: import.meta.env.VITE_CLOUDINARY_UPLOAD_PRESET as DataUnion,
  };
